class NotifiableAdmin::UserApi::V1::NotificationStatusesController < NotifiableAdmin::UserApi::V1::BaseController
  ...
  def find_notification_status!
    ...
    @notification_status = Notifiable::NotificationStatus.find_by_localized_notification_id_and_device_token_id!(params[:localized_notification_id], params[:device_token_id])
  end
